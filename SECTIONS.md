...
**61 moduler · 66767 rader kod · 19 med status · 42 utan.**
...
| :--- | ---: | :--- | ---: | :--- | :--- |
| `src/ui/app.rs` | 22104 | byggs — den stora ytan (UI + tillstånd). Kvar här: 8.7:s slice-UI, 8.10-vyns sträckt-märke, 8.4-samplern, 8.2:s fyra visningsställen | 5 | 76 (+1 ign) |  |
...
| `src/audio/tempo.rs` | 631 | stabil — tempokartan och `region_source_secs` | 48 | 12 | Tempokarta (Fas 8.2, steg 1).  |
...
- **Publika ingångar:** `ViewMode`, `ArrangerTool`, `RegionDragMode`, `RegionDragState`, `LibrarySampleItem`, `ChannelStrip`, `Pattern`, `TimeSnapMode`, `format_time_hundredths`, `format_bar_subdivisions`, `TrackKind`, `SongMarker` … (+173)
