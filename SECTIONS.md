...
**61 moduler · 64681 rader kod · 19 med status · 42 utan.**
...
| :--- | ---: | :--- | ---: | :--- | :--- |
| `src/ui/app.rs` | 21604 | byggs — den stora ytan (UI + tillstånd). Kvar här: 8.7:s slice-UI, 8.10-vyns sträckt-märke, 8.4-samplern, 8.2:s fyra visningsställen | 5 | 72 (+1 ign) |  |
...
- **Publika ingångar:** `ViewMode`, `ArrangerTool`, `RegionDragMode`, `RegionDragState`, `LibrarySampleItem`, `ChannelStrip`, `Pattern`, `TimeSnapMode`, `format_time_hundredths`, `format_bar_subdivisions`, `TrackKind`, `SongMarker` … (+170)
