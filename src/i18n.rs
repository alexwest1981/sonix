...
fn tr_en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "🎯 Kvantisera" => "🎯 Quantize",
        "🌀 Humanisera" => "🌀 Humanize",
        "Dra tagningens noter till närmaste rutnätslinje, med projektets sväng" => "Pull the take's notes to the nearest grid line, using the project swing",
        "Rutnät:" => "Grid:",
        "🎵 Läser in ljudbiblioteket i bakgrunden… ({:.0} s)" => "🎵 Loading the sample library in the background… ({:.0} s)",
        "🎵 Skannar ljudbiblioteket: {} samplar ({}, {:.0} s)" => "🎵 Scanning the sample library: {} samples ({}, {:.0} s)",
        "🎵 Ljudbiblioteket klart: {} samplar på {:.1} s" => "🎵 Sample library ready: {} samples in {:.1} s",
        "⚠ Kunde inte läsa in ljudbiblioteket — skanningen avbröts" => "⚠ Could not load the sample library — the scan was aborted",
        "Dither (TPDF, 16-bitars WAV)" => "Dither (TPDF, 16-bit WAV)",
        "Gör kvantiseringsfelet okorrelerat med materialet: jämnt brusgolv i stället för distorsion på svaga partier." => "Makes the quantization error uncorrelated with the material: an even noise floor instead of distortion on quiet passages.",
        "Noise shaping" => "Noise shaping",
        "Flyttar bruset uppåt i frekvens, där örat hör det sämre. Lägger mer energi i diskanten." => "Moves the noise up in frequency, where the ear hears it less. Adds more energy in the top end.",
        "🎯 Kvantisering av tagningen" => "🎯 Quantize the take",
        "🌀 Humanisering av tagningen" => "🌀 Humanize the take",
        "Styrka" => "Strength",
        "Humanisering" => "Humanize",
        "Hur hårt noterna dras mot rutnätet (0 % = oförändrat, 100 % = exakt på rutnätet)" => "How hard the notes are pulled to the grid (0% = unchanged, 100% = exactly on the grid)",
        "Hur mycket mänsklig otajthet och dynamik som läggs på" => "How much human timing and dynamics to add",
        "🎯 Kvantiserade {} noter ({}, styrka {:.0} %, sväng {:.0} %): {:.2} → {:.2} steg otajt" => "🎯 Quantized {} notes ({}, strength {:.0}%, swing {:.0}%): {:.2} → {:.2} steps off the grid",
        "🌀 Humaniserade {} noter (mängd {:.0} %: tid ±{:.2} steg, anslag ±{:.0} %): {:.2} → {:.2} steg otajt" => "🌀 Humanized {} notes (amount {:.0}%: timing ±{:.2} steps, velocity ±{:.0}%): {:.2} → {:.2} steps off the grid",
        ...
        "🛟 Osparat arbete hittades" => "🛟 Unsaved work found",
        "Sonix avslutades innan projektet sparades. Dessa automatiska kopior är nyare än filen på disk:" => "Sonix closed before the project was saved. These automatic copies are newer than the file on disk:",
        "  Återställ  " => "  Restore  ",
        "  Fortsätt utan att återställa  " => "  Continue without restoring  ",
        "Autosparningarna ligger i ~/.local/state/sonix/autosave/ (5 senaste per projekt). En återställd kopia pensioneras dit utan att raderas." => "Autosaves live in ~/.local/state/sonix/autosave/ (5 most recent per project). A restored copy is retired there rather than deleted.",
        "🛟 Autosparade '{}'" => "🛟 Autosaved '{}'",
        "🛟 Autosparade '{}' ({} äldre versioner städade)" => "🛟 Autosaved '{}' ({} older versions pruned)",
        "⚠ Kunde inte autospara: {}" => "⚠ Could not autosave: {}",
        "🛟 Återställde autosave för '{}' — granska och spara projektet" => "🛟 Restored autosave for '{}' — review and save the project",
        "⚠ Kunde inte återställa autosaven: {}" => "⚠ Could not restore the autosave: {}",
        "⚠ Kunde inte öppna '{}' i filhanteraren: {}" => "⚠ Could not open '{}' in the file manager: {}",
        " s sedan" => " s ago",
        " min sedan" => " min ago",
        " h sedan" => " h ago",
        " dygn sedan" => " days ago",
        ...
        "Skicka till buss:" => "Send to bus:",
        "Hur mycket av spåret som går till bussen (1,0 = lika starkt som spårets egen utgång)" => "How much of the track goes to the bus (1.0 = as loud as the track's own output)",
        ...
        "➡ Klippen står still när tempot ändras (Följ tempot av)" => "➡ The clips stay put when the tempo changes (Follow the tempo off)",
        "⏳ Sträcker {} klipp …" => "⏳ Stretching {} clips …",
        "🎚 {} klipp sträckta till {:.1} BPM (tonhöjden bevarad)." => "🎚 {} clips stretched to {:.1} BPM (pitch preserved).",
        "⚠ Kunde inte sträcka {} klipp: {} — originalet spelar." => "⚠ Could not stretch {} clips: {} — the original keeps playing.",
        "⏳ Sträcker {} klipp till {:.1} BPM — originalet spelar under tiden." => "⏳ Stretching {} clips to {:.1} BPM — the original plays meanwhile.",
        "📼 Bandspelare" => "📼 Tape",
        "🎚 Sträcks (bevarad tonhöjd)" => "🎚 Stretched (pitch preserved)",
        ...
        "Katalogiserade .fst-filer (endast metadata – FL Studios stängda .fst-format kan inte avkodas, så preset-datan visas men kan inte tillämpas):" => "Catalogued .fst files (metadata only – FL Studio's closed .fst format cannot be decoded, so the preset data is shown but cannot be applied):",
        "Kan inte tillämpas: .fst-presetdata kan inte avkodas. Plugins (CLAP/VST2/VST3) kan däremot laddas i plugin-panelen." => "Cannot be applied: .fst preset data cannot be decoded. Plugins (CLAP/VST2/VST3) can be loaded from the plugin panel instead.",
        ...
        "Spelar upp mikrofonen genom mastern (zero-latency). Använd hörlurar — med högtalare uppstår rundgång." => "Plays the microphone through the master bus (zero latency). Use headphones — speakers will cause feedback.",
        ...
        "📂 SPARADE PROJEKT:" => "📂 SAVED PROJECTS:",
        ...
        "Vägen dit går via FL Studio VSTi (.dll) körd genom Wine + yabridge. Sonix kan ladda och köra VST2/VST3/CLAP-bryggor (med PDC, state och GUI-fönster). Det som ännu inte verifierats här är en riktig yabridge-brygga med Wine + display." => "The route to this is FL Studio VSTi (.dll) run through Wine + yabridge. Sonix can load and run VST2/VST3/CLAP bridges (with PDC, state and a GUI window). What has not yet been verified here is a real yabridge bridge with Wine + display.",
        "Kraschskydd: plugins kan köras i en separat sandbox-process med minnesdelad ljudtransport. En kraschande plugin startas automatiskt om (max 3 gånger) utan att Sonix stängs – använd \"🧪 Sandbox-inspektera\" och \"🧪 Ladda in i sandbox\" i plugin-panelen." => "Crash isolation: plugins can run in a separate sandbox process with shared-memory audio transport. A crashing plugin is automatically restarted (up to 3 times) without taking Sonix down – use \"🧪 Sandbox inspect\" and \"🧪 Load into sandbox\" in the plugin panel.",
        ...
        "Lägg en punkt här, på faderns nuvarande nivå" => "Add a point here, at the fader's current level",
        "Bussens kurva — {} ({} punkter). Bussen äger den själv; flera spår kan skicka hit." => "The bus curve — {} ({} points). The bus owns it; several tracks can feed it.",
        "på" => "on",
        "av" => "off",
        "🔗 Buss {}: punkt vid takt {:.2} ({:.0} %)" => "🔗 Bus {}: point at bar {:.2} ({:.0} %)",
        "🎵 Till tonarten" => "🎵 To the key",
        "Flytta hela mönstret till tonarten — det kortaste skiftet som sätter flest toner i skalan" => "Move the whole pattern into the key — the shortest shift that puts the most notes in the scale",
        "🎵 Mönstret står redan i tonarten" => "🎵 The pattern is already in the key",
        "🎵 {} halvtoner till {}" => "🎵 {} semitones to {}",
        // Skalnamnen (Fas 8.11): literalerna bor kvar i `scale.rs` som nycklar — engelskan
        // kommer härifrån, så en svensk sträng aldrig läcker ut i det engelska gränssnittet.
        "Dur" => "Major",
        "Moll" => "Minor",
        "Harmonisk moll" => "Harmonic minor",
        "Melodisk moll" => "Melodic minor",
        "Dorian" => "Dorian",
        "Mixolydian" => "Mixolydian",
        "Pentatonisk moll" => "Minor pentatonic",
        "Pentatonisk dur" => "Major pentatonic",
        "Blues" => "Blues",
        "Synthwave" => "Synthwave",
        "Kromatisk" => "Chromatic",
        "EQ: låg (dB)" => "EQ: low (dB)",
        "EQ: mitten (dB)" => "EQ: mid (dB)",
        "EQ: hög (dB)" => "EQ: high (dB)",
        "Kompressor: tröskel (dB)" => "Compressor: threshold (dB)",
        "Kompressor: förhållande" => "Compressor: ratio",
        "Transponering (halvtoner)" => "Transpose (semitones)",
        ...
        "⬇ {} slicar till piano rollen." => "⬇ {} slices to the piano roll.",
        "Lägger en not per slice på stegraden, kromatiskt från basnoten. Fler slicar än steg kapas." => "Puts one note per slice on the step row, chromatically from the base note. More slices than steps are cut off.",
        "⚠ Inga slicar att dumpa — kör en slagletning först." => "⚠ No slices to dump — run a beat detection first.",
        "⬇ {} slicar till stegraden ({} kapades — raden har {} steg)." => "⬇ {} slices to the step row ({} cut off — the row has {} steps).",
        "⬇ {} slicar till stegraden." => "⬇ {} slices to the step row.",
        ...
        "Ingen MIDI-klaviatur hittad (koppla in en)" => "No MIDI keyboard found (plug one in)",
        "🔌 Koppla från MIDI" => "🔌 Disconnect MIDI",
        "🔌 Anslut MIDI" => "🔌 Connect MIDI",
        "MIDI-klaviatur frånkopplad." => "MIDI keyboard disconnected.",
        "✔ MIDI-in öppnad — klaviaturen ansluts automatiskt." => "✔ MIDI in opened — keyboards connect automatically.",
        ...
        "Tips: klaviaturen ansluts automatiskt. Hittas den inte: koppla in den och anslut igen." => "Tip: keyboards connect automatically. If it is not found: plug it in and connect again.",
        ...
        "CLAP/VST2/VST3: host aktiv (laddar plugins)" => "CLAP/VST2/VST3: host active (loads plugins)",
        "Endast metadata-skanning (bygg med --features plugin-host för CLAP/VST2/VST3-host)" => "Metadata scanning only (build with --features plugin-host for a CLAP/VST2/VST3 host)",
        "auto" => "auto",
        "steg" => "stepped",
        "mod" => "mod",
        "bypass" => "bypass",
        ...
        "🧪 Ladda in i sandbox" => "🧪 Load into sandbox",
        ...
        "Ingen" => "None",
        "Sidokedja:" => "Sidechain:",
        "🔍 Hitta slag" => "🔍 Find hits",
        "Leta transients i filen och dela den i slicar" => "Find transients in the file and split it into slices",
        "⚠ Kanalens ljud går inte att läsa — inga slag kan hittas" => "⚠ The channel's audio cannot be read — no hits can be found",
        "Inga slag hittades i filen" => "No hits were found in the file",
        "slicar" => "slices",
        "Slicar (klicka för att höra):" => "Slices (click to hear):",
        "Rensa slicar" => "Clear slices",
