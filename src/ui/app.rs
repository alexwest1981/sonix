...
impl SonixApp {
    ...
    pub fn new(engine: AudioEngine) -> Self {
        ...
        let kick = ChannelStrip {
            ...
            pitch_semitones: 0, pitch_fine_cents: 0.0, sample_start: 0.0, sample_end: 1.0, attack_decay: 0.3, loop_mode: crate::audio::LoopMode::Off, sample_loop_start: 0.0, sample_loop_end: 1.0, ping_pong: false, amp_env: crate::audio::envelope::AdsrParams::identity(), velocity_sensitivity: 1.0, filter: crate::audio::filter::SamplerFilter::default(), zones: Vec::new(), is_reverse: false,
        ...
        let snare = ChannelStrip {
            ...
            pitch_semitones: 0, pitch_fine_cents: 0.0, sample_start: 0.0, sample_end: 1.0, attack_decay: 0.4, loop_mode: crate::audio::LoopMode::Off, sample_loop_start: 0.0, sample_loop_end: 1.0, ping_pong: false, amp_env: crate::audio::envelope::AdsrParams::identity(), velocity_sensitivity: 1.0, filter: crate::audio::filter::SamplerFilter::default(), zones: Vec::new(), is_reverse: false,
        ...
        let clap = ChannelStrip {
            ...
            pitch_semitones: 0, pitch_fine_cents: 0.0, sample_start: 0.0, sample_end: 1.0, attack_decay: 0.5, loop_mode: crate::audio::LoopMode::Off, sample_loop_start: 0.0, sample_loop_end: 1.0, ping_pong: false, amp_env: crate::audio::envelope::AdsrParams::identity(), velocity_sensitivity: 1.0, filter: crate::audio::filter::SamplerFilter::default(), zones: Vec::new(), is_reverse: false,
        ...
        let hat = ChannelStrip {
            ...
            pitch_semitones: 0, pitch_fine_cents: 0.0, sample_start: 0.0, sample_end: 1.0, attack_decay: 0.2, loop_mode: crate::audio::LoopMode::Off, sample_loop_start: 0.0, sample_loop_end: 1.0, ping_pong: false, amp_env: crate::audio::envelope::AdsrParams::identity(), velocity_sensitivity: 1.0, filter: crate::audio::filter::SamplerFilter::default(), zones: Vec::new(), is_reverse: false,
        ...
        let open_hat = ChannelStrip {
            ...
            pitch_semitones: 0, pitch_fine_cents: 0.0, sample_start: 0.0, sample_end: 1.0, attack_decay: 0.6, loop_mode: crate::audio::LoopMode::Off, sample_loop_start: 0.0, sample_loop_end: 1.0, ping_pong: false, amp_env: crate::audio::envelope::AdsrParams::identity(), velocity_sensitivity: 1.0, filter: crate::audio::filter::SamplerFilter::default(), zones: Vec::new(), is_reverse: false,
        ...
        let crash = ChannelStrip {
            ...
            pitch_semitones: 0, pitch_fine_cents: 0.0, sample_start: 0.0, sample_end: 1.0, attack_decay: 0.7, loop_mode: crate::audio::LoopMode::Off, sample_loop_start: 0.0, sample_loop_end: 1.0, ping_pong: false, amp_env: crate::audio::envelope::AdsrParams::identity(), velocity_sensitivity: 1.0, filter: crate::audio::filter::SamplerFilter::default(), zones: Vec::new(), is_reverse: false,
