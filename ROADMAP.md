...
- [ ] **8.2 Tempo map** — tempobyten och taktart i låten (rör projektformat, export och SMF). — *steg 1 klart 2026-09-11, steg 2–3 kvar*
  ...
  - **Kvar på 8.2:** de 4 visningsställena (`render_playlist_arranger` ritar fortfarande px per sekund ur ett enda tempo, och snäppningen räknar i sekunder) — rätt så länge inga byten finns, fel när de gör det. Det är sista biten, och det är den som gör att tidlinjen ser rätt ut när ett byte väl finns.
  ...
  - **Kvar till steg 3:** de 4 visningsställena, **SMF-exporten** (som fortfarande skriver ett enda tempo och ska skriva tempobyten — kodeken tar redan en `bpm`, så den ska ta en karta), och UI:t där tempopunkter kan läggas till och tas bort.
