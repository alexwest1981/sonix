...
- [ ] **8.2 Tempo map** — tempobyten och taktart i låten (rör projektformat, export och SMF). — *steg 1 klart 2026-09-11, steg 2–3 kvar*
  ...
  - **Kvar till steg 2 slut och steg 3:** de ~14 placeringsställena (klistra in, lägg till, dela, söka, importera, spela in), `background_decode_stems`, 6 visningsställen, **SMF-exporten** (som fortfarande skriver ett enda tempo och ska skriva tempobyten), och UI:t där tempopunkter kan läggas till och tas bort.
