...
- [ ] **8.2 Tempo map** — tempobyten och taktart i låten (rör projektformat, export och SMF). — *steg 1 klart 2026-09-11, steg 2–3 kvar*
  ...
  - **SMF-vägen båda håll klart (2026-09-12).** Exporten skrev redan tempobyten (`write_midi_with_tempo` → `write_midi_with_tempo`-punkter ur kartan), men **importen** läste bara filens första tempo: `ParsedMidi.tempo_events` fanns och var oanvänd (med en `dead_code`-förklaring som sade "läses av importen när den tar med tempobyten (8.2 steg 3)").
